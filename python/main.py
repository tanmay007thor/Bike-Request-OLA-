...
from analysis import visualize_time_series, plot_acf_pacf, sarimax_analysis, hybrid_model_analysis
...
model, history, predictions = train_lstm_model(ts_data, look_back=30)
